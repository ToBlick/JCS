...
# 1D projection
    def test_splines(self):
        ...
        for type in ["clamped", "periodic"]:
            ...
            M0 = assemble(_M0, jnp.arange(n, dtype=jnp.int32), jnp.arange(n, dtype=jnp.int32))
...
# 1D projection
    ...
    def test_3d_splines_grad(self):
        ...
        basis0_θ = basis_θ
        basis0_ζ = basis_ζ
        basis0 = get_tensor_basis_fn((basis0_r, basis0_θ, basis0_ζ), 
                                    (n_r, n_θ, n_ζ))
        @jit
        def f(x):
            x, y, ζ  = x
        ...
        f_hat = jax.experimental.sparse.linalg.spsolve(M0.data, M0.indices, M0.indptr, proj0(f))
        ...
        basis1_1 = get_tensor_basis_fn(
                    (basis1_1_r, basis1_1_θ, basis1_1_ζ), 
                    (n_r-1, n_θ, n_ζ))
        N1_1 = (n_r-1) * n_θ * n_ζ
        basis1_2_r = basis_r
        basis1_2_θ = basis_dθ
        ...
        basis1_2 = get_tensor_basis_fn(
                    (basis1_2_r, basis1_2_θ, basis1_2_ζ), 
                    (n_r, n_θ-1, n_ζ))
        N1_2 = n_r * (n_θ-1) * n_ζ
        basis1_3_r = basis_r
        basis1_3_θ = basis_θ
        ...
        basis1_3 = get_tensor_basis_fn(
                    (basis1_3_r, basis1_3_θ, basis1_3_ζ), 
                    (n_r, n_θ, n_ζ))
        N1_3 = n_r * n_θ * n_ζ
        ...
        _M1 = (get_mass_matrix_lazy(basis1, x_q, w_q, None))
        M1 = assemble(_M1,
        ...
        npt.assert_allclose(vmap(grad(f_h))(_x), vmap(gradf_h)(_x), atol=1e-16)
        npt.assert_allclose(vmap(curl(gradf_h))(_x), 0, atol=1e-16)
        ...
        basis2_1_θ = basis_dθ
        basis2_1_ζ = basis_dζ
        basis2_1 = get_tensor_basis_fn((basis2_1_r, basis2_1_θ, basis2_1_ζ), 
                                    (n_r, n_θ-1, n_ζ))
        N2_1 = (n_r) * (n_θ - 1) * n_ζ
        basis2_2_r = basis_dr
        basis2_2_θ = basis_θ
        ...
        basis2_2 = get_tensor_basis_fn(
                    (basis2_2_r, basis2_2_θ, basis2_2_ζ), 
                    (n_r-1, n_θ, n_ζ))
        N2_2 = (n_r - 1) * (n_θ) * n_ζ
        basis2_3_r = basis_dr
        basis2_3_θ = basis_dθ
        ...
        basis2_3 = get_tensor_basis_fn(
                    (basis2_3_r, basis2_3_θ, basis2_3_ζ), 
                    (n_r-1, n_θ-1, n_ζ))
        ...
        _M2 = (get_mass_matrix_lazy(basis2, x_q, w_q, None))
        M2 = assemble(_M2,
